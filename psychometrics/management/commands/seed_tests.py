...
class Command(BaseCommand):
    ...
    def seed_all(self):
        ...
        self._seed(
            ...
            dimension='sombra',
            description='Las 5 heridas nucleares que generan máscaras relacionales: Rechazo, Abandono, Humillación, Traición e Injusticia. Identificar tu herida dominante no es para culpar al pasado — es para reconocer la máscara que usas hoy automáticamente.',
            estimated_minutes=8,
            order=40,
            questions_data=[
                {'t': '¿Sientes con frecuencia que no tienes derecho a existir o a ocupar un lugar?', 'd': 'Rechazo'},
                {'t': '¿Prefieres aislarte antes de arriesgarte a ser rechazado/a?', 'd': 'Rechazo'},
                {'t': '¿Te cuesta creer que alguien pueda amarte genuinamente?', 'd': 'Rechazo'},
                {'t': '¿Tiendes a minimizar tus éxitos pensando que no mereces lo que has conseguido?', 'd': 'Rechazo'},
                {'t': '¿Sientes una profunda necesidad de atención y validación de los demás?', 'd': 'Abandono'},
                {'t': '¿Te genera mucha ansiedad estar solo/a o que tus seres queridos se alejen temporalmente?', 'd': 'Abandono'},
                {'t': '¿Sueles asumir el papel de "víctima" para obtener apoyo o compañía?', 'd': 'Abandono'},
                {'t': '¿Tienes dificultades para tomar decisiones importantes sin consultar antes a los demás?', 'd': 'Abandono'},
                {'t': '¿Sientes a menudo vergüenza de ti mismo/a, de tu cuerpo o de tus necesidades?', 'd': 'Humillación'},
                {'t': '¿Pones las necesidades de los demás por encima de las tuyas, olvidándote de ti?', 'd': 'Humillación'},
                {'t': '¿Te sientes responsable de los problemas de los demás y que debes solucionarlos?', 'd': 'Humillación'},
                {'t': '¿Te castigas a ti mismo/a cuando cometes un error?', 'd': 'Humillación'},
                {'t': '¿Necesitas controlar las situaciones para sentirte seguro/a?', 'd': 'Traición'},
                {'t': '¿Te resulta muy difícil confiar en los demás y delegar tareas?', 'd': 'Traición'},
                {'t': '¿Sientes que debes demostrar constantemente que eres fuerte para que no te traicionen?', 'd': 'Traición'},
                {'t': '¿Te cuesta admitir tus propios errores o debilidades ante otros?', 'd': 'Traición'},
                {'t': '¿Te obsesiona que todo sea "justo" y "correcto" según tus estándares?', 'd': 'Injusticia'},
                {'t': '¿Te resulta difícil expresar tus sentimientos por miedo a perder el control?', 'd': 'Injusticia'},
                {'t': '¿Eres extremadamente exigente contigo mismo/a para alcanzar la perfección?', 'd': 'Injusticia'},
                {'t': '¿Tiendes a juzgar a los demás bajo criterios muy rígidos de lo que está "bien" o "mal"?', 'd': 'Injusticia'},
            ]
        )
